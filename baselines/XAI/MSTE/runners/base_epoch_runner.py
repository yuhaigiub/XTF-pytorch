...
class BaseEpochRunner(metaclass=ABCMeta):
    ...
    def __init__(self, cfg: Dict) -> None:
        ...
        # create model
        self.model, self.blackbox = self.build_model(cfg)
    ...
    def define_model_blackbox(self, cfg: Dict) -> nn.Module:
        """
        Define the model architecture based on the configuration.
        ...
        return cfg['BLACKBOX']['ARCH'](**cfg['BLACKBOX']['PARAM'])
    ...
    def build_model(self, cfg: Dict) -> nn.Module:
        ...
        blackbox = self.define_model_blackbox(cfg)
        blackbox = self.to_running_device(blackbox)
    ...
    def validate(self, cfg: Dict = None, train_epoch: Optional[int] = None):
        ...
        # #qassssssssssssssssssssssssssssssssssssssssssssss
        #     break
